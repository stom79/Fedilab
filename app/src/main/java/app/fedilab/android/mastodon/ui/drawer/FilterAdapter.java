...
public class FilterAdapter extends RecyclerView.Adapter<FilterAdapter.FilterViewHolder> {
    ...
    public void onBindViewHolder(@NonNull FilterViewHolder holder, int position) {
        ...
        holder.binding.editFilter.setOnClickListener(v -> {
            holder.binding.editFilter.setEnabled(false);
            FilterActivity.addEditFilter(context, filter, filter1 -> {
            ...
            }, () -> holder.binding.editFilter.setEnabled(true));
        });
