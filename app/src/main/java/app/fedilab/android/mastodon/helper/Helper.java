...
public class Helper {
    ...
    public static final String ARG_COLLECTION_ACCOUNT_ID = "ARG_COLLECTION_ACCOUNT_ID";
    public static final String ARG_OWN_COLLECTIONS = "ARG_OWN_COLLECTIONS";
    ...
    public static final Pattern peertubePattern = Pattern.compile("(https?://([\\da-z.-]+\\.[a-z.]{2,10}))/(?:videos/watch|videos/embed)/([\\w-]+)");
    public static final Pattern peertubeShortWatchPattern = Pattern.compile("(https?://([\\da-z.-]+\\.[a-z.]{2,10}))/w/([\\w-]+)");
